...
### Observações: 
A questão dois não apresenta **quais** maus cheiros persistem no código,
**onde** esses maus-cheiros se encontram, **quais** operações de refatoração são
aplicáveis, **quais** os impactos. A resposta resume-se a, simplesmente,
descrever de modo amplo e genérico duas situações. -60 pontos.

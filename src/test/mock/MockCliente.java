...
public class MockCliente {
    public static List<Cliente> getClientes() {
        return Arrays.asList(
                new Cliente("John Doe", false, 50.0, "Distrito Federal", true),
                ...
                new Cliente("Neymar Junior", true, 0.0, "Região Sul", true),
                new Cliente("Leonidas Souza", true, 150.0, "Distrito Federal", false));
    }

    public static Cliente getClientePrime() {
        return new Cliente("Neymar Junior", true, 0.0, "Região Sul", true);
    }

    public static Cliente getClientePadrao() {
        return new Cliente("John Doe", false, 50.0, "Distrito Federal", true);
    }
}
